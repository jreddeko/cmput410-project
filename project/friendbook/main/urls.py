...
urlpatterns = patterns('',
    ...
    url(r'^posts/(?P<post_id>[^/]+)/$', views.post, name='post'),
    url(r'^author/(?P<userID>[^/]+)/posts/$', views.authorposts, name='authorposts'),
    url(r'^author/(?P<userID>[^/]+)/posts/(?P<post_id>[^/]+)/comments/$', views.comments, name='post'),
    ...
    url(r'^friends/(?P<username>[\w\-]+)/(?P<friend_id>[\w\-]+)/$', views.friend, name='friend'),
